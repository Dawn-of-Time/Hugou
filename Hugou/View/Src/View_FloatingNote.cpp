...
void FloatingNote::setupUi()
{
	...
	const QFont timekeepingLabelFont = QFont("NeverMind", 12);
	const QFont floatingNoteButtonFont = QFont("NeverMind", 12, QFont::Bold);
	const QFont contentFont = QFont("NeverMind", 13);
	const QFont subcontentFont = QFont("NeverMind", 11, QFont::Light);
	...
	m_subcontentZone->setFont(subcontentFont);
