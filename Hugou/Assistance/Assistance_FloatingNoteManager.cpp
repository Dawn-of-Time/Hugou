...
FloatingNoteManager* FloatingNoteManager::m_manager = nullptr;
QMutex FloatingNoteManager::m_mutex;
...
FloatingNoteManager::~FloatingNoteManager()
{
    delete popupParallelGroup;
    delete dealLaterAnimation;
    delete dealNowAnimation;
}
...
FloatingNoteManager* FloatingNoteManager::getManager()
{
    if (m_manager == nullptr) {
        ...
        if (m_manager == nullptr) {
            m_manager = new FloatingNoteManager();
        }
    }
    return m_manager;
}
