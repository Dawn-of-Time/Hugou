...
{
	QString recycleBin;
	ConfigurationHelper::getHelper()->getPreferenceValue("recycleBin", recycleBin);
	if (recycleBin == "on")
	{
		QString retentionPeriod;
		ConfigurationHelper::getHelper()->getPreferenceValue("retentionPeriod", retentionPeriod);
